...
AG_MODEL_FILE = "models/weights.28-3.73.hdf5"
...
while capture.isOpened():
    ...
    for face in faces:
        ...
        if (gender == 'M' and emotion=="neutral"):
             
            cv2.imwrite("E:/New folder/Full project/AgeGenderEmotion and save face/Male/neutral/" + "neutral"+str(counter)+",age-"+str(age)+".png",face_img)
            counter = counter + 1
        elif (gender == 'M' and emotion=="happy"):
            cv2.imwrite("E:/New folder/Full project/AgeGenderEmotion and save face/Male/happy/" + "happy"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        elif (gender == 'M' and emotion=="surprise"):
            cv2.imwrite("E:/New folder/Full project/AgeGenderEmotion and save face/Male/surprise/" + "surprise"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        elif (gender == 'M' and emotion=="sad"):
            cv2.imwrite("E:/New folder/Full project/AgeGenderEmotion and save face/Male/sad/" + "sad"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        elif (gender == 'M' and emotion=="disgust"):
            cv2.imwrite("E:/New folder/Full project/AgeGenderEmotion and save face/Male/disgust/" + "disgust"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        elif (gender == 'M' and emotion=="angry"):
            cv2.imwrite("E:/New folder/Full project/AgeGenderEmotion and save face/Male/angry/" + "angry"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        elif (gender == 'M' and emotion=="fear"):
            cv2.imwrite("E:/New folder/Full project/AgeGenderEmotion and save face/Male/fear/" + "fear"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        if (gender == 'F' and emotion=="neutral"):
            cv2.imwrite("I:/last emo/AgeGenderEmotion/Male/FeMale/neutral/" + "neutral"+str(counter)+",age-"+str(age)+".png",face_img)
            counter = counter + 1
        elif (gender == 'F' and emotion=="happy"):
            cv2.imwrite("I:/last emo/AgeGenderEmotion/Male/FeMale/happy/" + "happy"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        elif (gender == 'F' and emotion=="surprise"):
            cv2.imwrite("I:/last emo/AgeGenderEmotion/Male/FeMale/surprise/" + "surprise"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        elif (gender == 'F' and emotion=="sad"):
            cv2.imwrite("I:/last emo/AgeGenderEmotion/Male/FeMale/sad/" + "sad"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        elif (gender == 'F' and emotion=="disgust"):
            cv2.imwrite("I:/last emo/AgeGenderEmotion/Male/FeMale/disgust/" + "disgust"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        elif (gender == 'F' and emotion=="angry"):
            cv2.imwrite("I:/last emo/AgeGenderEmotion/Male/FeMale/angry/" + "angry"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
        elif (gender == 'F' and emotion=="fear"):
            cv2.imwrite("I:/last emo/AgeGenderEmotion/Male/FeMale/fear/" + "fear"+str(counter1)+",age-"+str(age)+".png",face_img)
            counter1 = counter1 + 1
